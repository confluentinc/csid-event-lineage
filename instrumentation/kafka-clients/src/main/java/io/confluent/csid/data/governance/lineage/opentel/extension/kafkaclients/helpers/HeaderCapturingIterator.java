...
public class HeaderCapturingIterator<K, V> implements Iterator<ConsumerRecord<K, V>>,
   ...
   */
  public static <K, V> Iterator<ConsumerRecord<K, V>> wrap(Iterator<ConsumerRecord<K, V>> delegate,
   ...
   * {@link HeadersHolder} for automatic propagation on produce and capture service metadata.
   * <p>
   ...
   * <p>
   * Capture service name and cluster id to span as attributes
   *
